...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function (username, password) {
        ...
        this.userService.login(username, password)
            ...
            if (result) {
                _this.router.navigate(['/selection']);
            }
        })
            .catch(function (error) { return _this.showWrongPassword(true); });
    };
    LoginComponent.prototype.showWrongPassword = function (set) {
